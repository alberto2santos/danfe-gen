...
import { Sun, Moon, Settings2, RotateCcw } from 'lucide-react'
...
export function AppHeader({ onOpenSettings }: AppHeaderProps) {
  ...
  return (
    <>
      ...
      {/* Modal de ajuda — fora do header para evitar z-index issues */}
      <HelpModal
        open={helpOpen}
        onClose={() => setHelpOpen(false)}
        onNavigateToHelp={() => navigate('/ajuda')}
      />
    </>
  )
}